...
int main(){
	...
	if(slp.isDerivable(str))
		cout<<"Yes.This string belongs to the language derived from the grammar.\n";
	else cout<<"No. This string does not belong to the language derived from the grammar.\n";
	return 0;
}
